...
|-----|--------|------|-----------|------------|
| Intakes | [actual] | [norm] | [±%] | [✅/⚠️/🔴 + korte opmerking] |
| Bezoeken | ... | ... | ... | ... |
| Aanbiedingen | ... | ... | ... | ... |
| Matchgesprekken | ... | ... | ... | ... |
| Contractvoorstellen | ... | ... | ... | ... |
...
Deno.serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // Ratio-vergelijking
    const ratioKeys = ["intakes","bezoeken","aanbiedingen","matchgesprekken","contractvoorstellen"];
